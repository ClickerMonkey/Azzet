...
/**
 * Tests the {@link WebSource} class.
 * 
...
public class TestWeb 
{
	...
	public void testWeb()
	{
		BufferedImage img = Assets.load("http://www.google.com/logos/classicplus.png");
		
		assertNotNull( img );
		
		assertEquals( 275, img.getWidth() );
		assertEquals( 95, img.getHeight() );
	}
